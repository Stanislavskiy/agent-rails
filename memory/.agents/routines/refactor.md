...
Actions:
- Query mem0 for patterns and constraints relevant to the target module: `search_memory([target + goal], filter={category: [pattern, constraint]})`
...
Actions:
- Identify any pattern or constraint discovered during this task not already in memory
