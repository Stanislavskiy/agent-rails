...
Actions:
- Query mem0 for prior resolutions matching this symptom before investigating: `search_memory([bug description], filter={category: [gotcha, resolution, constraint]})`
...
## Step 5 — Capture Memory · act  (skip if no new learning)
Actions:
- Identify any gotcha, resolution, or constraint discovered during this task not already in memory
